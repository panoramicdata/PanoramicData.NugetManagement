...
public class NuGetDiscoveryService
{
		...
		CancellationToken cancellationToken = default)
	{
		...
		// Reported against what survived the listing filter: a retired package whose nuspec could not be
		// read is not something anyone needs to act on.
		var unresolved = listed
